package io.anuke.codetesting.utils;
...
public class BloomShader {
	 ...
	 */
	public BloomShader(int FBO_W, int FBO_H, boolean hasDepth, boolean useBlending,
			boolean use32bitFBO) {
	 ...
	 *            fbo use higher precision than 16bits.
	 */
	public BloomShader(int FBO_W, int FBO_H, FrameBuffer sceneIsCapturedHere,
